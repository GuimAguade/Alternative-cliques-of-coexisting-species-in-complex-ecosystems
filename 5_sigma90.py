...
# THE FOLLOWING CODE EXPLORES THE FRACTION OF UNSTABLE SIMULATIONS FOR INCREASING SIGMA TO ESTIMATE THE SIGMA_90 VALUE FOR WHICH
# 90% OF RUNS HAVE BECOME UNSTABLE
...
# Scatter plot
plt.plot(varAlist, Frac_cycles)
plt.xlabel('std(A)')
plt.ylabel('Fraction of unstable')
